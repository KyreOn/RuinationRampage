...
[System.Serializable]
public class StylizedBloomPostProcessPass : ScriptableRenderPass
{
    ...
    private StylizedBloomVolume m_bloomEffect;
    
    public StylizedBloomPostProcessPass(Material bloomMaterial, Material compositeMaterial)
    {
    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
    {
        ...
        m_bloomEffect = stack.GetComponent<StylizedBloomVolume>();
